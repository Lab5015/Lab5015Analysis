...
import os, re
#import commands  #in py2
import subprocess #modifica per py3
import math, time
import sys
import argparse
import subprocess
...
cfgFolder = '/afs/cern.ch/user/f/ftonetto/francesco/Lab5015Analysis/cfg/TOFHIR2C/'
# ----
...
if not (os.path.isfile(temp_min)):
   ...
   os.system(command) #subprocess.run(command, shell=True, check=True)  in py3
