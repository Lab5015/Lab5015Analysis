...
int main(int argc, char** argv)
{
  ...
  std::map<int,TH1F*> h1_energyR;
    ...
    std::map<int,TH1F*> h1_timeL;
    std::map<int,TH1F*> h1_timeR;
  ...
  for(int entry = 0; entry < nEntries; ++entry) {
	...
	if( h1_totL[index] == NULL )
	{
	  ...
	  h1_qfineR[index] = new TH1F(Form("h1_qfine_bar%02dR_Vov%.2f_th%02.0f",iBar,Vov,vth),"",512,-0.5,511.5);
        ...
        h1_timeL[index] = new TH1F(Form("h1_time_bar%02dL_Vov%.2f_th%02.0f",iBar,Vov,vth),"",2E5,-1000.,1000.);
        h1_timeR[index] = new TH1F(Form("h1_time_bar%02dR_Vov%.2f_th%02.0f",iBar,Vov,vth),"",2E5,-1000.,1000.);
